...
class GANLabModel {
  constructor(
    noiseSize,
    numGeneratorLayers,
    numDiscriminatorLayers,
    numGeneratorNeurons,
    numDiscriminatorNeurons,
    batchSize,
    lossType
  ) {
      this.dVariables = null;
      this.gVariable = null;

      this.dOptimizer  = null;
      this.gOptimizer = null;
  ...
  generator(noiseTensor) {
    ...
    const gfcLastW =
      this.gVariables[2 + this.numGeneratorLayers * 2];
    const gfcLastB =
  ...
  updateOptimizer(
    dOrG, optimizerType, learningRate) {
